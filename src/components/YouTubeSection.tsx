      ...
      <div className="container mx-auto px-6 relative">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            Free chess tutorials, opening guides, endgame lessons, and game analysis on YouTube. Subscribe and level up your chess game.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div className="relative">
              <div className="absolute -inset-3 rounded-2xl bg-red-500/5 blur-xl" />
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                DailyChess_12 creates high-quality chess content for players of all levels. From opening theory to endgame mastery, every video is designed to help you improve your game step by step.
              </p>
              <ul className="space-y-2 mb-8 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                  Opening guides & repertoire building
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                  Tactical puzzles & pattern recognition
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                  Game analysis & endgame technique
                </li>
              </ul>
              <a
              ...
              >
                <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white font-semibold group">
