 ...
 *
 * Tournament date: 23 July 2026, 16:00 CEST.
 */
const DISMISS_KEY = "mc.dbcup.hero.dismissed";
const EVENT_AT = new Date("2026-07-23T14:00:00Z").getTime(); // 16:00 CEST
const HIDE_AFTER = new Date("2026-07-24T00:00:00Z").getTime();
      ...
      <div className="relative flex flex-col gap-4 p-4 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-amber-100/90 text-sm sm:text-base font-semibold">
            23 July 2026 · 16:00 CEST · Official MasterChess Tournament
          </p>
          {!live && (
