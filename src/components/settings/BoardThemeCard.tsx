...
/**
 * Visual preview card for a board theme — uniform square preview area
...
export default function BoardThemeCard({ theme, active, onSelect }: Props) {
  return (
    ...
    >
      ...
      <div className="w-full aspect-square mb-2 transition-transform duration-300 group-hover:scale-[1.03]">
