...
export const LESSON_MOVES: Record<string, LessonMoveData> = {
  ...
  // ===== JOBAVA LONDON MASTERKURS (30 LESSONS) =====
  "jl-1": {
    moves: [
      M("d4", "1.d4 — White claims the center, the launching pad of every Queen's-pawn opening."),
      M("d5", "1...d5 — Locking the center and gaining space, Benoni-style."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("Nf6", "2...Nf6 — Standard developing/regrouping move."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("e6", "3...e6 — Solid central support, Queen's-pawn style."),
      M("e3", "4.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("Bd6", "4...Bd6 — Natural piece development."),
      M("Bg3", "5.Bg3 — Tucking the bishop behind the h2-pawn and keeping the long h2-b8 diagonal open."),
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("Bd3", "6.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
      M("c5", "6...c5 — The principled challenge to White's center."),
      M("Nf3", "7.Nf3 — Final minor piece out, eyeing e5."),
      M("Nc6", "7...Nc6 — Standard developing/regrouping move."),
      M("O-O", "8.O-O — White castles short, finishing development and connecting rooks."),
      M("b6", "8...b6 — Preparing the queenside fianchetto."),
      M("Ne5", "9.Ne5 — The dream square: a centralized knight that supports a kingside attack."),
      M("Bb7", "9...Bb7 — Natural piece development."),
      M("f4", "10.f4 — Stonewall-style: cementing the e5-knight and clearing the way for a kingside attack."),
    ],
  },
  "jl-2": {
    moves: [
      ...
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("e6", "3...e6 — Solid central support, Queen's-pawn style."),
      M("f3", "4.f3 — Solid prophylaxis: blunts ...Ne4 ideas and prepares e4."),
      M("c5", "4...c5 — The principled challenge to White's center."),
      M("e4", "5.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("cxd4", "5...cxd4 — Central exchange."),
      M("Qxd4", "6.Qxd4 — Centralizing the queen on the strongest square."),
      M("Nc6", "6...Nc6 — Standard developing/regrouping move."),
      M("Bb5", "7.Bb5 — Pin on the c6 knight, gaining tempo for development."),
      M("Bd7", "7...Bd7 — Natural piece development."),
      M("Bxc6", "8.Bxc6 — Forced trade or thematic capture in this Jobava structure."),
      M("Bxc6", "8...Bxc6 — Forced trade or thematic capture in this Jobava structure."),
      M("O-O-O", "9.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
    ],
  },
  "jl-3": {
    moves: [
      ...
      M("Nf6", "2...Nf6 — Standard developing/regrouping move."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("c5", "3...c5 — The principled challenge to White's center."),
      M("e3", "4.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("Nc6", "4...Nc6 — Standard developing/regrouping move."),
      M("Nb5", "5.Nb5 — A typical Jobava jump, attacking c7 and probing the queenside."),
      M("e5", "5...e5 — Central pawn break."),
      M("dxe5", "6.dxe5 — Capturing in the center, opening lines."),
      M("Ne4", "6...Ne4 — Continuing the plan."),
      M("Qxd5", "7.Qxd5 — Centralizing the queen with tempo."),
      M("Qa5+", "7...Qa5 — Pinning along the a5-e1 diagonal."),
      M("c3", "8.c3 — Solid center support."),
      M("Bf5", "8...Bf5 — Natural piece development."),
      M("Nd6+", "9.Nd6+ — Continuing the plan."),
      M("Nxd6", "9...Nxd6 — Trading off the powerful knight on its way home."),
      M("exd6", "10.exd6 — Recapturing and keeping a strong protected pawn on d6."),
    ],
  },
  "jl-4": {
    moves: [
      ...
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("e6", "3...e6 — Solid central support, Queen's-pawn style."),
      M("Qd2", "4.Qd2 — Preparing long castling and lining the queen up for Bh6 ideas against ...g6 setups."),
      M("Be7", "4...Be7 — Natural piece development."),
      M("O-O-O", "5.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("h4", "6.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("c5", "6...c5 — The principled challenge to White's center."),
      M("e4", "7.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("cxd4", "7...cxd4 — Central exchange."),
      M("Qxd4", "8.Qxd4 — Centralizing the queen on the strongest square."),
      M("Nc6", "8...Nc6 — Standard developing/regrouping move."),
      M("Qe3", "9.Qe3 — Eyeing both flanks; flexible attacking square."),
      M("d4", "1...d4 — White claims the center, the launching pad of every Queen's-pawn opening."),
      M("Qg3", "10.Qg3 — Queen swings to the kingside, ready to support the attack."),
    ],
  },
  "jl-5": {
    moves: [
      M("d4", "1.d4 — White claims the center, the launching pad of every Queen's-pawn opening."),
      M("Nf6", "1...Nf6 — Standard developing/regrouping move."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("g6", "2...g6 — Preparing the kingside fianchetto, King's Indian-style."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("Bg7", "3...Bg7 — Natural piece development."),
      M("e4", "4.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("d6", "4...d6 — Solid central support."),
      M("Qd2", "5.Qd2 — Preparing long castling and lining the queen up for Bh6 ideas against ...g6 setups."),
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("O-O-O", "6.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("c6", "6...c6 — Solid center support."),
      M("Bh6", "7.Bh6 — Trading off the fianchettoed bishop, the main defender of Black's king."),
      M("b5", "7...b5 — Black launches his own counter-storm."),
      M("h4", "8.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("b4", "8...b4 — Pushing further, kicking the c3-knight."),
      M("Nce2", "9.Nce2 — Sidestepping the b-pawn, regrouping toward g3 or f4."),
      M("Nxe4", "9...Nxe4 — Sharp tactical attempt to grab the e4-pawn."),
      M("Qe3", "10.Qe3 — Eyeing both flanks; flexible attacking square."),
    ],
  },
  "jl-6": {
    moves: [
      ...
      M("e3", "4.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("d6", "4...d6 — Solid central support."),
      M("h4", "5.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("h5", "5...h5 — Pushing further to break open the enemy king with hxg6 or h6."),
      M("Nf3", "6.Nf3 — Final minor piece out, eyeing e5."),
      M("O-O", "6...O-O — Black castles short, finishing development and connecting rooks."),
      M("Ng5", "7.Ng5 — Hopping forward, eyeing weak squares like f7 and e6."),
      M("c5", "7...c5 — The principled challenge to White's center."),
      M("dxc5", "8.dxc5 — Capturing in the center, opening lines."),
      M("Qa5", "8...Qa5 — Pinning along the a5-e1 diagonal."),
      M("cxd6", "9...cxd6 — Central exchange."),
      M("exd6", "9...exd6 — Recapturing and keeping a strong protected pawn on d6."),
      M("Qxd6", "10.Qxd6 — Continuing the plan."),
    ],
  },
  "jl-7": {
    moves: [
      ...
      M("Nf6", "1...Nf6 — Standard developing/regrouping move."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("e6", "2...e6 — Solid central support, Queen's-pawn style."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("Bb4", "3...Bb4 — Natural piece development."),
      M("e3", "4.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("c5", "4...c5 — The principled challenge to White's center."),
      M("a3", "5.a3 — Forcing the bishop to commit on c3 or retreat."),
      M("Bxc3+", "5...Bxc3+ — Continuing the plan."),
      M("bxc3", "6...bxc3 — Forced recapture."),
      M("Qa5", "6...Qa5 — Pinning along the a5-e1 diagonal."),
      M("Ne2", "7.Ne2 — Flexible knight square, can swing to f4 or g3."),
      M("Nd5", "7...Nd5 — Standard developing/regrouping move."),
      M("Qd2", "8.Qd2 — Preparing long castling and lining the queen up for Bh6 ideas against ...g6 setups."),
      M("Nc6", "8...Nc6 — Standard developing/regrouping move."),
      M("Bd6", "9...Bd6 — Natural piece development."),
      M("cxd4", "9...cxd4 — Central exchange."),
      M("exd4", "10.exd4 — Recapture in the center."),
    ],
  },
  "jl-8": {
    moves: [
      ...
      M("Nf6", "1...Nf6 — Standard developing/regrouping move."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("c5", "2...c5 — The principled challenge to White's center."),
      M("d5", "3.d5 — Locking the center and gaining space, Benoni-style."),
      M("g6", "3...g6 — Preparing the kingside fianchetto, King's Indian-style."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("Bg7", "4...Bg7 — Natural piece development."),
      M("e4", "5.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("d6", "5...d6 — Solid central support."),
      M("Qd2", "6.Qd2 — Preparing long castling and lining the queen up for Bh6 ideas against ...g6 setups."),
      M("O-O", "6...O-O — Black castles short, finishing development and connecting rooks."),
      M("O-O-O", "7.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("e6", "7...e6 — Solid central support, Queen's-pawn style."),
      M("dxe6", "8.dxe6 — Continuing the plan."),
      M("Bxe6", "8...Bxe6 — Forced trade or thematic capture in this Jobava structure."),
      M("Bxd6", "9.Bxd6 — Forced trade or thematic capture in this Jobava structure."),
      M("Re8", "9...Re8 — Activating the rook on the e-file behind the central pawn."),
      M("e5", "10.e5 — Central pawn break."),
    ],
  },
  "jl-9": {
    moves: [
      ...
      M("c5", "4...c5 — The principled challenge to White's center."),
      M("Nb5", "5.Nb5 — A typical Jobava jump, attacking c7 and probing the queenside."),
      M("Na6", "5...Na6 — Slightly awkward but defends c7."),
      M("Nf3", "6.Nf3 — Final minor piece out, eyeing e5."),
      M("Bd7", "6...Bd7 — Natural piece development."),
      M("c3", "7.c3 — Solid center support."),
      M("Be7", "7...Be7 — Natural piece development."),
      M("a4", "8.a4 — Gaining queenside space and stopping ...b5 ideas."),
      M("O-O", "8...O-O — Black castles short, finishing development and connecting rooks."),
      M("Bd3", "9.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
      M("Bd6", "9...Bd6 — Natural piece development."),
      M("O-O", "10.O-O — White castles short, finishing development and connecting rooks."),
    ],
  },
  "jl-10": {
    moves: [
      ...
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("h4", "6.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("b6", "6...b6 — Preparing the queenside fianchetto."),
      M("h5", "7.h5 — Pushing further to break open the enemy king with hxg6 or h6."),
      M("Bb7", "7...Bb7 — Natural piece development."),
      M("Nf3", "8.Nf3 — Final minor piece out, eyeing e5."),
      M("Nbd7", "8...Nbd7 — Standard developing/regrouping move."),
      M("Ne5", "9.Ne5 — The dream square: a centralized knight that supports a kingside attack."),
      M("Nxe5", "9...Nxe5 — Forced recapture."),
      M("dxe5", "10.dxe5 — Capturing in the center, opening lines."),
    ],
  },
  "jl-11": {
    moves: [
      ...
      M("Nf6", "1...Nf6 — Standard developing/regrouping move."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("b6", "2...b6 — Preparing the queenside fianchetto."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("Bb7", "3...Bb7 — Natural piece development."),
      M("f3", "4.f3 — Solid prophylaxis: blunts ...Ne4 ideas and prepares e4."),
      M("e6", "4...e6 — Solid central support, Queen's-pawn style."),
      M("e4", "5.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("Bb4", "5...Bb4 — Natural piece development."),
      M("Bd3", "6.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
      M("c5", "6...c5 — The principled challenge to White's center."),
      M("dxc5", "7.dxc5 — Capturing in the center, opening lines."),
      M("bxc5", "7...bxc5 — Forced recapture."),
      M("Ne2", "8.Ne2 — Flexible knight square, can swing to f4 or g3."),
      M("O-O", "8...O-O — Black castles short, finishing development and connecting rooks."),
      M("O-O", "9.O-O — White castles short, finishing development and connecting rooks."),
      M("d6", "9...d6 — Solid central support."),
      M("Bd6", "10...Bd6 — Natural piece development."),
    ],
  },
  "jl-12": {
    moves: [
      ...
      M("Nf6", "1...Nf6 — Standard developing/regrouping move."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("d6", "2...d6 — Solid central support."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("g6", "3...g6 — Preparing the kingside fianchetto, King's Indian-style."),
      M("e4", "4.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("Bg7", "4...Bg7 — Natural piece development."),
      ...
      M("b5", "7...b5 — Black launches his own counter-storm."),
      M("h4", "8.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("Bxh6", "8...Bxh6 — Black accepts the trade, hoping to neutralize the attack."),
      M("Qxh6", "9.Qxh6 — Queen to h6: the assault square. Mate threats are in the air."),
      M("Nbd7", "9...Nbd7 — Standard developing/regrouping move."),
      M("h5", "10.h5 — Pushing further to break open the enemy king with hxg6 or h6."),
    ],
  },
  "jl-13": {
    moves: [
      ...
      M("Nf3", "7.Nf3 — Final minor piece out, eyeing e5."),
      M("Bb7", "7...Bb7 — Natural piece development."),
      M("Ne5", "8.Ne5 — The dream square: a centralized knight that supports a kingside attack."),
      M("Nbd7", "8...Nbd7 — Standard developing/regrouping move."),
      M("f4", "9.f4 — Stonewall-style: cementing the e5-knight and clearing the way for a kingside attack."),
      M("c5", "9...c5 — The principled challenge to White's center."),
      M("Bh4", "10.Bh4 — Repositioning the bishop to keep pressure on f6."),
    ],
  },
  "jl-14": {
    moves: [
      ...
      M("Nf6", "1...Nf6 — Standard developing/regrouping move."),
      M("Nc3", "2.Nc3 — The Jobava signature: the knight develops to its most active square BEFORE c2-c3 is played."),
      M("d5", "2...d5 — Locking the center and gaining space, Benoni-style."),
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("Ne4", "3...Ne4 — Continuing the plan."),
      M("Nxe4", "4...Nxe4 — Sharp tactical attempt to grab the e4-pawn."),
      M("dxe4", "4...dxe4 — Continuing the plan."),
      M("e3", "5.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("c5", "5...c5 — The principled challenge to White's center."),
      M("c3", "6.c3 — Solid center support."),
      M("Nc6", "6...Nc6 — Standard developing/regrouping move."),
      M("Qc2", "7.Qc2 — Eyeing h7 and supporting future e4 breaks."),
      M("f5", "7...f5 — Continuing the plan."),
      M("f3", "8.f3 — Solid prophylaxis: blunts ...Ne4 ideas and prepares e4."),
      M("exf3", "8...exf3 — Continuing the plan."),
      M("Nxf3", "9.Nxf3 — Continuing the plan."),
      M("e6", "9...e6 — Solid central support, Queen's-pawn style."),
      M("Bd3", "10.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
    ],
  },
  "jl-15": {
    moves: [
      ...
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("e6", "3...e6 — Solid central support, Queen's-pawn style."),
      M("Nf3", "4.Nf3 — Final minor piece out, eyeing e5."),
      M("Bd6", "4...Bd6 — Natural piece development."),
      M("Bg3", "5.Bg3 — Tucking the bishop behind the h2-pawn and keeping the long h2-b8 diagonal open."),
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("e3", "6.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("c5", "6...c5 — The principled challenge to White's center."),
      M("Bd3", "7.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
      M("Nc6", "7...Nc6 — Standard developing/regrouping move."),
      M("O-O", "8.O-O — White castles short, finishing development and connecting rooks."),
      M("Nb4", "8...Nb4 — Standard developing/regrouping move."),
      M("Nb5", "9.Nb5 — A typical Jobava jump, attacking c7 and probing the queenside."),
      M("Bxg3", "9...Bxg3 — Forced trade or thematic capture in this Jobava structure."),
      M("Bxh7+", "10.Bxh7+ — Continuing the plan."),
    ],
  },
  "jl-16": {
    moves: [
  ...
  "jl-17": {
    moves: [
      ...
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("c5", "3...c5 — The principled challenge to White's center."),
      M("dxc5", "4.dxc5 — Capturing in the center, opening lines."),
      M("Nc6", "4...Nc6 — Standard developing/regrouping move."),
      M("e4", "5.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("e5", "5...e5 — Central pawn break."),
      M("Bg5", "6.Bg5 — Pinning the f6-knight and adding kingside pressure."),
      M("d4", "1...d4 — White claims the center, the launching pad of every Queen's-pawn opening."),
      M("Nd5", "7...Nd5 — Standard developing/regrouping move."),
      M("Bxc5", "7...Bxc5 — Forced trade or thematic capture in this Jobava structure."),
      M("Bxf6", "8.Bxf6 — Doubling Black's pawns and weakening the kingside."),
      M("gxf6", "8...gxf6 — Forced recapture."),
      M("Qf3", "9.Qf3 — Developing the queen with attacking ideas on f6 and h5."),
      M("Be6", "9...Be6 — Natural piece development."),
      M("Nxf6+", "10.Nxf6+ — Continuing the plan."),
    ],
  },
  "jl-18": {
    moves: [
      ...
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("c5", "3...c5 — The principled challenge to White's center."),
      M("d5", "4.d5 — Locking the center and gaining space, Benoni-style."),
      M("exd5", "4...exd5 — Recapture in the center."),
      M("Nxd5", "5.Nxd5 — Continuing the plan."),
      M("Nxd5", "5...Nxd5 — Continuing the plan."),
      M("Qxd5", "6.Qxd5 — Centralizing the queen with tempo."),
      M("Nc6", "6...Nc6 — Standard developing/regrouping move."),
      M("O-O-O", "7.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("Be7", "7...Be7 — Natural piece development."),
      M("e4", "8.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("O-O", "8...O-O — Black castles short, finishing development and connecting rooks."),
      M("Nf3", "9.Nf3 — Final minor piece out, eyeing e5."),
      M("d6", "9...d6 — Solid central support."),
      M("Bd6", "10...Bd6 — Natural piece development."),
    ],
  },
  "jl-19": {
    moves: [
      ...
      M("e4", "4.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("exd5", "4...exd5 — Recapture in the center."),
      M("exd5", "5.exd5 — Recapture in the center."),
      M("d6", "5...d6 — Solid central support."),
      M("Nf3", "6.Nf3 — Final minor piece out, eyeing e5."),
      M("Be7", "6...Be7 — Natural piece development."),
      M("Bd3", "7.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
      M("O-O", "7...O-O — Black castles short, finishing development and connecting rooks."),
      M("O-O", "8.O-O — White castles short, finishing development and connecting rooks."),
      M("a6", "8...a6 — Preparing ...b5 expansion."),
      M("Re1", "9.Re1 — Activating the rook on the e-file behind the central pawn."),
      M("b5", "9...b5 — Black launches his own counter-storm."),
      M("a4", "10.a4 — Gaining queenside space and stopping ...b5 ideas."),
    ],
  },
  "jl-20": {
    moves: [
      ...
      M("Nxd5", "5...Nxd5 — Continuing the plan."),
      M("Qxd5", "6.Qxd5 — Centralizing the queen with tempo."),
      M("d6", "6...d6 — Solid central support."),
      M("Nf3", "7.Nf3 — Final minor piece out, eyeing e5."),
      M("Nc6", "7...Nc6 — Standard developing/regrouping move."),
      M("O-O-O", "8.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("Be7", "8...Be7 — Natural piece development."),
      M("e4", "9.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("O-O", "9...O-O — Black castles short, finishing development and connecting rooks."),
      M("Bd3", "10.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
    ],
  },
  "jl-21": {
    moves: [
      ...
      M("Nc6", "7...Nc6 — Standard developing/regrouping move."),
      M("dxc5", "8.dxc5 — Capturing in the center, opening lines."),
      M("Bxc5", "8...Bxc5 — Forced trade or thematic capture in this Jobava structure."),
      M("h5", "9.h5 — Pushing further to break open the enemy king with hxg6 or h6."),
      M("Re8", "9...Re8 — Activating the rook on the e-file behind the central pawn."),
      M("h6", "10.h6 — Cementing the cramping pawn deep in the enemy camp."),
    ],
  },
  "jl-22": {
    moves: [
      ...
      M("Bf4", "3.Bf4 — The London bishop, ahead of its pawn chain, eyeing c7 and the kingside."),
      M("d5", "3...d5 — Locking the center and gaining space, Benoni-style."),
      M("Nb5", "4.Nb5 — A typical Jobava jump, attacking c7 and probing the queenside."),
      M("Na6", "4...Na6 — Slightly awkward but defends c7."),
      M("e3", "5.e3 — The quiet, solid Jobava: a strong center without committing the e-pawn yet."),
      M("c5", "5...c5 — The principled challenge to White's center."),
      M("c3", "6.c3 — Solid center support."),
      M("Bd7", "6...Bd7 — Natural piece development."),
      M("a4", "7.a4 — Gaining queenside space and stopping ...b5 ideas."),
      M("Be7", "7...Be7 — Natural piece development."),
      M("Nf3", "8.Nf3 — Final minor piece out, eyeing e5."),
      M("O-O", "8...O-O — Black castles short, finishing development and connecting rooks."),
      M("Bd3", "9.Bd3 — The light-squared bishop joins the attack on the b1-h7 diagonal — the classic Jobava battery."),
  ...
  "jl-23": {
    moves: [
      ...
      M("d6", "4...d6 — Solid central support."),
      M("Qd2", "5.Qd2 — Preparing long castling and lining the queen up for Bh6 ideas against ...g6 setups."),
      M("Nc6", "5...Nc6 — Standard developing/regrouping move."),
      M("O-O-O", "6.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("O-O", "6...O-O — Black castles short, finishing development and connecting rooks."),
      M("f3", "7.f3 — Solid prophylaxis: blunts ...Ne4 ideas and prepares e4."),
      M("e5", "7...e5 — Central pawn break."),
      M("dxe5", "8.dxe5 — Capturing in the center, opening lines."),
      M("dxe5", "8...dxe5 — Capturing in the center, opening lines."),
      M("Be3", "9.Be3 — Quietly redeploying the bishop to a safe central square."),
      M("Qe7", "9...Qe7 — Solid central queen, supporting ...O-O-O if needed."),
      M("Nh3", "10.Nh3 — Modern flexible development, often heading to f4 or g5."),
    ],
  },
  "jl-24": {
    moves: [
      ...
      M("e4", "5.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("Nc6", "5...Nc6 — Standard developing/regrouping move."),
      M("Nb5", "6.Nb5 — A typical Jobava jump, attacking c7 and probing the queenside."),
      M("e5", "6...e5 — Central pawn break."),
      M("dxe5", "7.dxe5 — Capturing in the center, opening lines."),
      M("Nh5", "7...Nh5 — Continuing the plan."),
      M("exd5", "8.exd5 — Recapture in the center."),
      M("Nxf4", "8...Nxf4 — Continuing the plan."),
      M("dxc6", "9.dxc6 — Capturing in the center, opening lines."),
      M("Qxd1+", "9...Qxd1+ — Trading queens to simplify into a favorable endgame."),
      M("Rxd1", "10.Rxd1 — Recapturing with the rook into the open file."),
    ],
  },
  "jl-25": {
    moves: [
      ...
      M("h4", "5.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("h5", "6.h5 — Pushing further to break open the enemy king with hxg6 or h6."),
      M("c5", "6...c5 — The principled challenge to White's center."),
      M("hxg6", "7.hxg6 — Ripping open the kingside."),
      M("fxg6", "7...fxg6 — Forced recapture."),
      M("Nf3", "8.Nf3 — Final minor piece out, eyeing e5."),
      M("Nc6", "8...Nc6 — Standard developing/regrouping move."),
      M("Bc4+", "9.Bc4 — Bishop to the active diagonal targeting f7."),
      M("Kh8", "9...Kh8 — Tucking the king into the corner before the storm hits."),
      M("Ng5", "10.Ng5 — Hopping forward, eyeing weak squares like f7 and e6."),
    ],
  },
  "jl-26": {
    moves: [
      ...
      M("Re1", "9.Re1 — Activating the rook on the e-file behind the central pawn."),
      M("Bb7", "9...Bb7 — Natural piece development."),
      M("e4", "10.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
    ],
  },
  "jl-27": {
    moves: [
      ...
      M("Nc6", "4...Nc6 — Standard developing/regrouping move."),
      M("Nb5", "5.Nb5 — A typical Jobava jump, attacking c7 and probing the queenside."),
      M("Qa5+", "5...Qa5 — Pinning along the a5-e1 diagonal."),
      M("c3", "6.c3 — Solid center support."),
      M("cxd4", "6...cxd4 — Central exchange."),
      M("exd4", "7.exd4 — Recapture in the center."),
      M("e5", "7...e5 — Central pawn break."),
      M("dxe5", "8.dxe5 — Capturing in the center, opening lines."),
      M("Ne4", "8...Ne4 — Continuing the plan."),
      M("Qxd5", "9.Qxd5 — Centralizing the queen with tempo."),
      M("Bf5", "9...Bf5 — Natural piece development."),
      M("Nd6+", "10.Nd6+ — Continuing the plan."),
    ],
  },
  "jl-28": {
    moves: [
  ...
  "jl-29": {
    moves: [
      ...
      M("e6", "4...e6 — Solid central support, Queen's-pawn style."),
      M("e4", "5.e4 — The aggressive Jobava: grabbing the full center and opening lines fast."),
      M("Bxc5", "5...Bxc5 — Forced trade or thematic capture in this Jobava structure."),
      M("exd5", "6.exd5 — Recapture in the center."),
      M("exd5", "6...exd5 — Recapture in the center."),
      M("Bb5+", "7.Bb5 — Pin on the c6 knight, gaining tempo for development."),
      M("Nc6", "7...Nc6 — Standard developing/regrouping move."),
      M("Nge2", "8.Nge2 — Modern Jobava development, keeping f3-pawn for flexibility."),
      M("O-O", "8...O-O — Black castles short, finishing development and connecting rooks."),
      M("O-O", "9.O-O — White castles short, finishing development and connecting rooks."),
      M("Bd6", "9...Bd6 — Natural piece development."),
      M("Bg5", "10.Bg5 — Pinning the f6-knight and adding kingside pressure."),
    ],
  },
  "jl-30": {
    moves: [
      ...
      M("O-O", "5...O-O — Black castles short, finishing development and connecting rooks."),
      M("O-O-O", "6.O-O-O — Castling long! White commits to the kingside pawn storm — the soul of the Jobava."),
      M("a6", "6...a6 — Preparing ...b5 expansion."),
      M("Bh6", "7.Bh6 — Trading off the fianchettoed bishop, the main defender of Black's king."),
      M("b5", "7...b5 — Black launches his own counter-storm."),
      M("h4", "8.h4 — The pawn storm starts. Once kings are on opposite wings, every tempo counts."),
      M("Bb7", "8...Bb7 — Natural piece development."),
      M("h5", "9.h5 — Pushing further to break open the enemy king with hxg6 or h6."),
      M("Nxh5", "9...Nxh5 — Forced recapture."),
      M("Rxh5", "10.Rxh5! — Exchange sacrifice to demolish the kingside cover."),
      M("gxh5", "10...gxh5 — Forced recapture."),
    ],
  },
};
