...
export const BOT_PROFILES: BotProfile[] = [
  ...
  },
  {
    ...
    country: "Worldwide",
    countryFlag: "🌍",
    style: "World-elite strength",
    bio: "Top-tier play. Beating me is a real achievement 👑",
    drawAcceptThreshold: 85,
    resignThreshold: 600,
    taunts: {
      greeting: "Show me your best 👑",
      onCheck: "Precise check 🎯",
      onCapture: "Calculated capture 👑",
      onBlunder: "A blemish — extremely rare 😤",
      onWin: "Game over. Mastery confirmed 👑🏆",
      onLose: "You were truly excellent. Respect 🤝",
      onDraw: "A worthy draw 👑🤝",
      onDrawOffer: "Equal — agreed 👑",
      onDrawDecline: "Pressing for the win 👑",
    },
  },
];
