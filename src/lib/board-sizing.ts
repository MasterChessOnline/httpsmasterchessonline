...
export const BOARD_CONTAINER_CLASS =
  ...
  // Slim side panel (~17rem) → board gets the rest of the screen for focus.
  "lg:max-w-[min(calc(100svh-6rem),calc(100vw-18rem),940px)] " +
  "xl:max-w-[min(calc(100svh-5rem),calc(100vw-17rem),1060px)] " +
  "2xl:max-w-[min(calc(100svh-5rem),1180px)]";
