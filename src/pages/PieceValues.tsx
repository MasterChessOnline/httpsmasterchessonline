...
const PIECES = [
  ...
  { name: "Bishop", symbol: "♗", value: 3.25, color: "text-purple-400", bg: "bg-purple-500/10", desc: "The sniper. Controls long diagonals and excels in open positions.", tips: ["Bishop pair is very strong", "Best in open positions", "Place pawns on opposite color"] },
