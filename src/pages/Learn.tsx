    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="hidden">
        {course.lessons.map((lesson, idx) => {
          ...
          // Strip "Variation N: " or "Chapter N: " prefixes for clean card title
          const cleanTitle = lesson.title.replace(/^(Variation|Chapter|Lesson)\s+\d+:\s*/i, "");
          // Try to extract a move line from content; otherwise use first key point
          const moveLine =
