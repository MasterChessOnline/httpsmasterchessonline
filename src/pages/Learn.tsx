      ...
      {hasExercise && (() => {
        ...
        return (
          <div id="exercise-section" className="mb-6">
            ...
            <VariationsExercise variations={variations} fallbackFen={isMasterclass ? undefined : lesson.fen} orientation={orientation} courseId={course.id} courseTitle={course.title} />
          </div>
        );
      })()}
...
const Learn = () => {
  ...
  return (
    <div className="min-h-screen bg-background grid-bg">
      <Seo title={"Learn Chess — Master Courses, Openings & Training | MasterChess"} description={"Master courses, opening trees, and tactical training drills. Learn chess by playing — no static lessons."} path="/learn" type="website" jsonLd={{ "@context": "https://schema.org", "@type": "Course", name: "MasterChess Learn", description: "Master courses, openings and training drills covering tactics, strategy and endgames.", provider: { "@type": "Organization", name: "MasterChess", sameAs: "https://masterchess-live.lovable.app" } }} />
      <Navbar />
