              ...
              {streak?.freeze_available ? (
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground">
                      Refills after a new win streak
                    </p>
                  </div>
                </>
              )}
        ...
        >
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2">
              ...
              <span>Missions reset every midnight — new ones every day.</span>
            </li>
            <li className="flex gap-2">
              <Trophy className="h-4 w-4 text-primary/60 shrink-0 mt-0.5" />
              <span>Wins against humans and bots both count toward missions.</span>
            </li>
            <li className="flex gap-2">
            ...
            <li className="flex gap-2">
              ...
              <span>Once a mission is complete, click <strong className="text-primary">Claim</strong> to collect your XP.</span>
            </li>
          </ul>
        </motion.div>
      </main>
