...
import { Trophy, Clock, Users, Zap, Swords, BookOpen, Timer, Lock, Crown, Gem, Shield } from "lucide-react";
...
const Tournaments = () => {
  ...
  const [viewMode, setViewMode] = useState<"all" | "vip">("all");
      ...
      <main className="container mx-auto px-6 pt-24 pb-16">
        ...
        <div className="flex justify-center gap-2 mb-6">
          <button
            ...
            className={`flex items-center gap-2 rounded-full px-5 py-2 text-sm font-medium transition-all border ${
              viewMode === "all" ? "border-primary bg-primary/10 text-primary" : "border-border/50 bg-muted/30 text-muted-foreground hover:border-primary/30"
            }`}
          >
          ...
          >
            <Gem className="h-3.5 w-3.5" /> VIP Tournaments
        ...
        {viewMode === "vip" && !isElitePlus ? (
          <div className="max-w-md mx-auto text-center py-16">
            ...
            <h2 className="text-xl font-bold mb-2" style={{ fontFamily: "var(--font-display)" }}>VIP Tournaments</h2>
              ...
              <article className="rounded-xl border border-purple-500/20 bg-card p-5 transition-all hover:border-purple-500/30">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Elite-only 5+3 blitz tournament with premium rewards.</p>
              ...
              <article className="rounded-xl border border-amber-500/20 bg-card p-5 transition-all hover:border-amber-500/30">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Private rapid tournament for Grandmaster tier members only.</p>
                    <div className="flex items-center gap-4 text-xs text-muted-foreground mt-2 flex-wrap">
