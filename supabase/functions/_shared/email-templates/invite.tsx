...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You're invited to join MasterChess</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Text style={text}>
            You've been invited to join <Link href={siteUrl} style={link}><strong style={gold}>{siteName}</strong></Link> — the premium platform for serious chess.
          </Text>
